"""Shared test setup for Pi Agent unit tests.

Import this module at the top of any test file before importing plugin
...
# Mock AstrBot public API so plugin modules can be imported standalone.
